...
from utility.finance import daily_returns, get_daily_returns, get_ETF_beta_to_SPY, get_total_return, calculate_percentile_value, get_symbol_from_returns_df, ceiling_scrub, floor_scrub, calculate_average_daily_move_from_returns, calculate_SD_multiple_from_returns
...
# WHAT DO I CALL THESE PARAMS, also at the moment it is not easy to scrub based initial_initial_scrub and not based on percentile.
