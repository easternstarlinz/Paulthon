...
from option_model.Event_Module import IdiosyncraticVol, ComplexEvent
from option_model.Distribution_Module import Distribution_MultiIndex
...
if __name__ == '__main__':
    ...
    elagolix_info = pd.read_excel('/Users/paulwainer/Paulthon/Events/Parameters/CLVS_RiskScenarios.xlsx',
                             header = [0],
                             index_col = [0,1],
