...
class OLS(object):
    def __init__(self,
        ...
        self.beta1_numerator = sum([(i[1] - self.y_bar)*(i[0] - self.x_bar) for i in self.pairs])
        self.beta1_denominator = sum([(i[0] - self.x_bar)**2 for i in self.pairs])
        self.beta1 = self.beta1_numerator / self.beta1_denominator
