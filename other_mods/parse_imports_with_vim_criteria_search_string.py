...
def create_multiple_criteria_vim_search_string(phrases: 'list of imports'):
...
def get_search_string_for_python_imports(file_name):
    """Create a search string to be used in Vim when searching for where imports are used in the file."""
    imports = get_imports_for_python_file(file_name)
    search_string = create_multiple_criteria_vim_search_string(imports)
    return search_string
