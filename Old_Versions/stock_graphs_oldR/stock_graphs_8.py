...
class OLSPair(object):
    ...
    def __init__(self
        ...
        self.raw_pairs = OLS(pairs = self.raw_pairs, name = 'Raw Pairs').ols()
        print("SUMMARY HERE")
        print(self.raw_pairs)
        ...
        self.inital_scrub = OLS(self.initial_scrub).ols()
        ...
        self.second_scrub = OLS(self.second_scrub).ols()
