...
class StockParams(object):
    def __init__(self, MainParams, StockChartParams, ScatterPlotParams)
...
class Params(sym1, sym2, cutoff, data_points):
    def __init__(self):
        self.sym1 = sym1
        self.sym2 = sym2
        self.cutoff = sym3
...
my_pairing_3 = copy.deepcopy(my_pairing)
my_pairing_3.index = 'IBB'
my_pairing_3.StockChart(base100=False, beta_setting='scrubbed', manual_beta=1.0)
my_pairing_3.StockChart()
