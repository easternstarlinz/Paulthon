...
def corr_pair(sym1: 'str', sym2: 'str', index_cutoff = .01, stock_cutoff = .1) -> 'list of tuples':
    ...
    #create arrays of cc_moves (-> lists)
    ...
    #scrubbed cc_move pairs in individual list form
    ...
    print("second scrub---- ", "beta1:", round(beta1, 3),", beta0:", round(beta0, 5), ", count: ", len(x), sep="")
    ...
    #create a tuple with x, y, y_hat, error, error squared
    ...
    print("after deleting biggest outlier---- ", "beta1:", round(beta1, 3),", beta0:", round(beta0, 5), ", count: ", len(x3), sep="")

corr_pair('IBB', 'SRPT', index_cutoff=.0125, stock_cutoff=.075)
