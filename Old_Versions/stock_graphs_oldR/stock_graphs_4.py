...
def corr_pair(sym1: 'str', sym2: 'str', index_cutoff = .01, stock_cutoff = .1, pct_cutoff = .15, data_points = 500, base100=True, beta_setting: 'str'= 'scrubbed', manual_beta: 'float' = 1.0, scatter_type='all') -> 'list of tuples':
    ...
    #create Adj. Stock Graph based on beta_value to the index
    ...
    if base100 == True:
        ...
        plt.plot(dates, adjusted_stock_prices_base100, color='gold', label= (str(sym2) + " beta_value-adjusted (base100)"))
    else:
    ...
    #Scrub Outliers based on input parameters
