...
from option_model.Distribution_Module import Distribution
from option_model.Option_Module import Option, OptionPriceDist, OptionPriceMC, get_implied_volatility
from option_model.Event_Module import IdiosyncraticVol, Event, SysEvt_PresElection, TakeoutEvent
from functools import reduce
import pylab


"""------------------------------Calculations----------------------------------------"""
def show_term_structure(mc_distributions):
    i = 1
...
events0 = [event0]
events1 = [event0, event1]
events2 = [event0, event1, event2]
events3 = [event0, event1, event2, event3]
events4 = [event0, event1, event2, event3, event4]
events5 = [event0, event1, event2, event3, event4, event5]
events6 = [event0, event1, event2, event3, event4, event5, event6]
events7 = [event0, event1, event2, event3, event4, event5, event6, event7]

#event_groupings = [events0, events1, events2, events3, events4, events5, events6, events7]
#event_groupings = [events0, events4, events6, events7]
...
mc_iterations = 10**6
option_sheet(event_groupings.values(), expiry, mc_iterations)
