...
def run4():
    ...
    simulation_total = simulation1 + simulation2 + simulation3 + simulation4 + simulation5 + simulation6 + simulation7
    print(simulation_total)
    #print(simulation1, simulation2, simulation3, simulation4, simulation5, simulation6, simulation7)
