Here, I outline step by step how I calculate my betas.
    -Part 1: How I calculate beta_value for a given stock and ETF.
    -Part 2 is simple: For a given stock, I run the beta_value calculation (Part 1) for each ETF candidate. I deem the "Best Beta" as the ETF pairing that produces the highest R^2 value.
    ...
    A)
        ...
        -ScrubParams
            ...
            -Percentile Cutoff -- Keep only the data points with the highest quality fit
                -Value of .80 -- would remove the 20% worst fitting data points and re-calculate beta_value
